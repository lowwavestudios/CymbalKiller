...
//==============================================================================
IceyGateAudioProcessorEditor::IceyGateAudioProcessorEditor (IceyGateAudioProcessor& p)
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    title = Drawable::createFromImageData(cymbalKillerTitle_svg2, cymbalKillerTitle_svg2Size); // title
    cachedImage_logo2020_png2_1 = ImageCache::getFromMemory(logoSmall_png, logoSmall_pngSize); // logo

    crossoverSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, CROSSOVER_ID, crossoverSlider);
    ...
    thresholdLowSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, THRESHOLD2_ID, thresholdLowSlider);
    attackLowSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, ATTACK2_ID, attackLowSlider);
    holdLowSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, HOLD2_ID, holdLowSlider);
    releaseLowSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, RELEASE2_ID, releaseLowSlider);

    inputGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, INPUT_ID, inputGainSlider);
    outputGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, OUTPUT_ID, outputGainSlider);
    mixSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(processor.parameters, MIX_ID, mixSlider);
    laButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(processor.parameters, LA_ID, laButton);
    scButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(processor.parameters, SC_ID, scButton);

    soloLowButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(processor.parameters, SOLOLOW_ID, soloLowButton);
    soloHiButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(processor.parameters, SOLOHI_ID, soloHiButton);

    addAndMakeVisible(processor.visualiser); //visualiser High Freq
    addAndMakeVisible(processor.visualiserLowFreq); //visualiser LowFreq

    addAndMakeVisible(&crossoverSlider);
    crossoverSlider.setRange(20.0f, 20000.0f, 1.0f);
    crossoverSlider.addListener(this);
    crossoverSlider.setDoubleClickReturnValue(true, 500.0f);
    crossoverSlider.setSliderSnapsToMousePosition(true);
    

    addAndMakeVisible(&thresholdSlider);
    thresholdSlider.setRange(-90.0f, 0.0f, 0.01f);
    thresholdSlider.setDoubleClickReturnValue(true, 0.0f);
    thresholdSlider.addListener(this);
    thresholdSlider.setSliderSnapsToMousePosition(true);
    thresholdSlider.setLookAndFeel(&threshLAF);

    addAndMakeVisible(&attackSlider);
    attackSlider.setRange(0.01f, 100.0f, 0.01f);
    attackSlider.setDoubleClickReturnValue(true, 0.01f);
    attackSlider.addListener(this);
    attackSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&holdSlider);
    holdSlider.setRange(1.f, 500.f, 0.1f);
    holdSlider.setDoubleClickReturnValue(true, 35.0f);
    holdSlider.addListener(this);
    holdSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&releaseSlider);
    releaseSlider.setRange(1.f, 500.0f, 0.1f);
    releaseSlider.setDoubleClickReturnValue(true, 120.0f);
    releaseSlider.addListener(this);
    releaseSlider.setSliderSnapsToMousePosition(true);


    addAndMakeVisible(&thresholdLowSlider);
    thresholdLowSlider.setRange(-90.0f, 0.0f, 0.01f);
    thresholdLowSlider.setDoubleClickReturnValue(true, 0.0f);
    thresholdLowSlider.addListener(this);
    thresholdLowSlider.setSliderSnapsToMousePosition(true);
    thresholdLowSlider.setLookAndFeel(&threshLAF);

    addAndMakeVisible(&attackLowSlider);
    attackLowSlider.setRange(0.01f, 100.0f, 0.01f);
    attackLowSlider.setDoubleClickReturnValue(true, 0.01f);
    attackLowSlider.addListener(this);
    attackLowSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&holdLowSlider);
    holdLowSlider.setRange(1.f, 500.f, 0.1f);
    holdLowSlider.setDoubleClickReturnValue(true, 80.0f);
    holdLowSlider.addListener(this);
    holdLowSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&releaseLowSlider);
    releaseLowSlider.setRange(1.f, 1000.0f, 0.1f);
    releaseLowSlider.setDoubleClickReturnValue(true, 250.0f);
    releaseLowSlider.addListener(this);
    releaseLowSlider.setSliderSnapsToMousePosition(true);
    

    addAndMakeVisible(&inputGainSlider);
    inputGainSlider.setRange(-96.f, 12.f, 0.01f);
    inputGainSlider.setSkewFactorFromMidPoint(-9.f);
    inputGainSlider.setDoubleClickReturnValue(true, 0.0f);
    inputGainSlider.addListener(this);
    inputGainSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&outputGainSlider);
    outputGainSlider.setRange(-96.f, 12.f, 0.01f);
    outputGainSlider.setSkewFactorFromMidPoint(-9.f);
    outputGainSlider.setDoubleClickReturnValue(true, 0.0f);
    outputGainSlider.addListener(this);
    outputGainSlider.setSliderSnapsToMousePosition(true);

    addAndMakeVisible(&scHPFSlider);
    scHPFSlider.setRange(20.0f, 5000.f, 1.0f);
    scHPFSlider.addListener(this);
    scHPFSlider.setDoubleClickReturnValue(true, 20.f);
    scHPFSlider.setSliderSnapsToMousePosition(true);
    
    
    addAndMakeVisible(&scLPFSlider);
    scLPFSlider.setRange(150.0f, 20000.f, 1.0f);
    scLPFSlider.addListener(this);
    ...
    addAndMakeVisible(&laButton);
    laButton.addListener(this);
    laButton.setLookAndFeel(&buttonLAF);

    addAndMakeVisible(&scButton);
    scButton.addListener(this);
    scButton.setLookAndFeel(&buttonLAF);

    addAndMakeVisible(&soloLowButton);
    soloLowButton.addListener(this);
    soloLowButton.setLookAndFeel(&soloLAF);

    addAndMakeVisible(&soloHiButton);
    soloHiButton.addListener(this);
    soloHiButton.setLookAndFeel(&soloLAF);
    ...
    thresholdLowSlider.setTextValueSuffix(" dB");
    attackLowSlider.setTextValueSuffix(" ms");
    releaseLowSlider.setTextValueSuffix(" ms");
    holdLowSlider.setTextValueSuffix(" ms");
    ...
    attackLowSlider.setSkewFactorFromMidPoint(10.0f);
    releaseLowSlider.setSkewFactorFromMidPoint(250.0f);
    holdLowSlider.setSkewFactorFromMidPoint(100.f);
...
IceyGateAudioProcessorEditor::~IceyGateAudioProcessorEditor()
{
...
//==============================================================================
void IceyGateAudioProcessorEditor::paint (Graphics& g)
{
    ...
    area = getLocalBounds();
    //int width = area.getWidth(), height = area.getHeight();

    auto windowHeight = area.getHeight();
    auto windowWidth = area.getWidth();

    square = area.getHeight() / 60;
    sliderHeight = 3 * square;
    sliderSpacing = 2 * square;
    sideMargin = square;
...

    {
        ...
        auto rect = juce::Rectangle<int>(x, y, windowWidth, windowHeight);
        g.fillRect(rect);
        /*
        jassert(fundo != nullptr);
        if (fundo != nullptr)
            fundo->drawWithin(g, rect.toFloat(),
                RectanglePlacement::stretchToFit, 1.000f);
        //fundo->replaceColour(Colour(165, 71, 7), Colour());
        */
    }
    ...
    //    for (int s = 0; s < 60; s++)
    //    {
    //        g.drawLine(0, s * square, area.getWidth(), s * square, 0.75f);
    //        g.setFont(square / 1.5);
    //        g.drawText(std::to_string(s), 0, s * square, 40, 10, Justification::centredLeft);
    //    }
    //    for (int s = 0; s < 40; s++)
    //    {
    //        g.drawLine(s * square, 0, s * square, area.getHeight(), 0.75f);
    //        g.setFont(square / 1.5);
    //        g.drawText(std::to_string(s), s * square, 0, 40, 10, Justification::centredLeft);
    //    }
    ...
    {//draw header
        ...
        header.setBounds(0, 0, windowWidth, 4 * square);
        g.setOpacity(0.3f);
        g.drawRect(header);
        g.fillRect(header);
    ...
    {//draw footer
        ...
        footer.setBounds(0, area.getHeight() - sliderHeight, windowWidth, sliderHeight);
        g.setOpacity(0.3f);
        g.drawRect(footer);
        g.fillRect(footer);
    ...
    {//draw title
        ...
        int x = 14 * square, y = square, width = 12 * square, height = 2 * square;
        ...
        g.setFont(Font::bold);
        g.setFont(height); 
        g.drawText("Cymbal Killer", x, y, width, height, Justification::centred);
    }
    
    {// help button
        help->setBounds(windowWidth - (square *2), square * 1.5f, square, square);
    ...
    {//draw logo
        int x = square, y = square, w = 6 * square, h = w * (372.f/891.f) ;
    ...
    {//draw param back rectangles
        auto rLow = Rectangle<float>(sideMargin * 0.5, attackLowSlider.getY() - (2 * sideMargin), attackLowSlider.getWidth() + sideMargin, (5 * sliderHeight) + sideMargin);
        g.setColour(Colour(7, 112, 165));
        g.setOpacity(0.25f);
        g.fillRoundedRectangle(rLow, 5);

        auto rHigh = Rectangle<float>(attackSlider.getX() - (sideMargin * 0.5), attackLowSlider.getY() - (2 * sideMargin), attackLowSlider.getWidth() + sideMargin, (5 * sliderHeight) + sideMargin);
        g.setColour(Colour(7, 165, 18));
        g.setOpacity(0.25f);
        g.fillRoundedRectangle(rHigh, 5);
    }

    paramTextStyle(g, "X-Over", sideMargin, crossoverSlider.getY(), (area.getWidth() * 0.25f) - (2 * sideMargin), windowHeight * (15.f/600.f), true, Justification::horizontallyCentred);
    paramTextStyle(g, "Mix", mixSlider.getX() - (3*square), mixSlider.getY() - (0.75*square), area.getWidth() * 0.25f, windowHeight * (12.f / 600.f), false, Justification::centredLeft);

    paramTextStyle(g, "In ", square, 3.5 * square, 3 * square, windowHeight * (10.f / 600.f), false, Justification::bottomLeft);
    paramTextStyle(g, "Out ", 21 * square, 3.5 * square, 4 * square, windowHeight * (10.f / 600.f), false, Justification::bottomLeft);
    ...
    paramTextStyle(g, "Release (Low-Band)", releaseLowSlider.getX(), releaseLowSlider.getY() - (sliderHeight * 0.65), releaseLowSlider.getWidth(), windowHeight * (10.f / 600.f), false, Justification::horizontallyCentred, Colour::fromRGBA(171, 171, 171, 0.75));

    paramTextStyle(g, "Attack (High-Band)", attackSlider.getX(), attackSlider.getY() - (sliderHeight * 0.65), attackSlider.getWidth(), windowHeight * (10.f / 600.f), false, Justification::horizontallyCentred, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Hold (High-Band)", holdSlider.getX(), holdSlider.getY() - (sliderHeight * 0.65), holdSlider.getWidth(), windowHeight * (10.f / 600.f), false, Justification::horizontallyCentred, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Release (High-Band)", releaseSlider.getX(), releaseSlider.getY() - (sliderHeight * 0.65), releaseSlider.getWidth(), windowHeight * (10.f / 600.f), false, Justification::horizontallyCentred, Colour::fromRGBA(171, 171, 171, 0.75));
}

void IceyGateAudioProcessorEditor::paintOverChildren(Graphics& g)
{
    keepAspectRatio();
    ...
    thresholdSlider.setBounds(processor.visualiser.getBounds());
    thresholdLowSlider.setBounds(processor.visualiserLowFreq.getBounds());

}

void IceyGateAudioProcessorEditor::resized()
{
    keepAspectRatio();
    ...
    square = area.getHeight() / 60;
    sliderHeight = 5 * square;
    sliderSpacing = 2 * square;
    sideMargin = square;


    //setBounds for sliders
    //juce::Rectangle<int>(area.removeFromBottom(sliderHeight / 2));
    juce::Rectangle<int>(area.removeFromBottom(sliderHeight));
    
    releaseSlider.setBounds(area.removeFromBottom(sliderHeight).reduced(sideMargin).removeFromRight((area.getWidth() * 0.5f) - (2 * sideMargin)));
    holdSlider.setBounds(area.removeFromBottom(sliderHeight).reduced(sideMargin).removeFromRight((area.getWidth() * 0.5f) - (2 * sideMargin)));
    attackSlider.setBounds(area.removeFromBottom(sliderHeight).reduced(sideMargin).removeFromRight((area.getWidth() * 0.5f) - (2 * sideMargin)));

    releaseLowSlider.setBounds(sideMargin, releaseSlider.getY(), releaseSlider.getWidth(), releaseSlider.getHeight());
    holdLowSlider.setBounds(sideMargin, holdSlider.getY(), releaseSlider.getWidth(), releaseSlider.getHeight());
    attackLowSlider.setBounds(sideMargin, attackSlider.getY(), releaseSlider.getWidth(), releaseSlider.getHeight());
    
    //Set Bounds Visualiser
    ...
    auto sliderTrueWidth = crossoverSlider.getWidth();



    inputGainSlider.setBounds(sideMargin * 3, 5 * square, 16 * square, sliderTrueHeight / 2);
    outputGainSlider.setBounds(windowWidth - sideMargin - (sliderTrueWidth / 2), 5 * square, 15 * square, sliderTrueHeight / 2.f);



    mixSlider.setBounds(windowWidth - (sliderTrueWidth / 2) - sideMargin, windowHeight - sideMargin - (sliderTrueHeight / 2), sliderTrueWidth / 2, sliderTrueHeight / 2);
    ...
    scButton.setBounds(0.25 * windowWidth, windowHeight - sideMargin - (sliderTrueHeight / 2), sliderTrueHeight, sliderTrueHeight / 2);

    soloLowButton.setBounds(processor.visualiserLowFreq.getX() + (processor.visualiserLowFreq.getWidth() / 2) - (0.5 * square), processor.visualiserLowFreq.getY() - (2 * square), sliderTrueHeight, sliderTrueHeight / 2);
    soloHiButton.setBounds(processor.visualiser.getX() + (processor.visualiser.getWidth() / 2) - (0.5*square), processor.visualiser.getY() - (2 * square), sliderTrueHeight, sliderTrueHeight / 2);
    newButtonStyle(Colours::whitesmoke, Colour(83, 163, 3), Colours::grey);

}


void IceyGateAudioProcessorEditor::buttonClicked(Button* buttonThatHasChanged)
{
    if (buttonThatHasChanged == &laButton)
    {
        processor.lookahead = laButton.getToggleState();
    }

    else if (buttonThatHasChanged == &scButton)
    {
        processor.sidechain = scButton.getToggleState();
    }

    else if (buttonThatHasChanged == &soloHiButton)
    {
        processor.soloHi = soloHiButton.getToggleState();
    }
    else if (buttonThatHasChanged == &soloLowButton)
    {
        processor.soloLow = soloLowButton.getToggleState();
    }
}

void IceyGateAudioProcessorEditor::sliderValueChanged(Slider* sliderThatHasChanged)
{
    
    if (sliderThatHasChanged == &thresholdSlider)
    {
        processor.curThreshHigh = thresholdSlider.getValue(); 
    }
    else if (sliderThatHasChanged == &attackSlider)
    {
        processor.curAtkTimeHigh = attackSlider.getValue();

    }
    else if (sliderThatHasChanged == &releaseSlider)
    {
        processor.curRelTimeHigh = releaseSlider.getValue();
        
    }
    else if (sliderThatHasChanged == &holdSlider)
    {
        processor.curHoldTimeHigh = holdSlider.getValue();

    }
    else if (sliderThatHasChanged == &thresholdLowSlider)
    {
        processor.curThreshLow = thresholdLowSlider.getValue();

    }
    else if (sliderThatHasChanged == &attackLowSlider)
    {
        processor.curAtkTimeLow = attackLowSlider.getValue();

    }
    else if (sliderThatHasChanged == &releaseLowSlider)
    {
        processor.curRelTimeLow = releaseLowSlider.getValue();

    }
    else if (sliderThatHasChanged == &holdLowSlider)
    {
        processor.curHoldTimeLow = holdLowSlider.getValue();

    }

    else if (&crossoverSlider == sliderThatHasChanged)
    {
        processor.crossoverFreq = crossoverSlider.getValue();
        
    }
    else if (&inputGainSlider == sliderThatHasChanged)
    {
        processor.inputGain = inputGainSlider.getValue();
        
    }
    else if (&outputGainSlider == sliderThatHasChanged)
    {
        processor.outputGain = outputGainSlider.getValue();
        
    }
    else if (&scHPFSlider == sliderThatHasChanged)
    {
        processor.scHPF = scHPFSlider.getValue();
    }
    else if (&scLPFSlider == sliderThatHasChanged)
    {
        processor.scLPF = scLPFSlider.getValue();
    }
    else if (&mixSlider == sliderThatHasChanged)
    {
        processor.drywet = mixSlider.getValue();
    }

}

void IceyGateAudioProcessorEditor::timerCallback() 
{
...
void IceyGateAudioProcessorEditor::newButtonStyle(Colour textColour, Colour tickColour, Colour disableColour)
{
    ...
    laButton.setColour(ToggleButton::textColourId, textColour);
    laButton.setColour(ToggleButton::tickColourId, tickColour);
    laButton.setColour(ToggleButton::tickDisabledColourId, disableColour);

    scButton.setColour(ToggleButton::textColourId, textColour);
    scButton.setColour(ToggleButton::tickColourId, tickColour);
    scButton.setColour(ToggleButton::tickDisabledColourId, disableColour);

    soloHiButton.setColour(ToggleButton::textColourId, textColour);
    soloHiButton.setColour(ToggleButton::tickColourId, tickColour);
    soloHiButton.setColour(ToggleButton::tickDisabledColourId, disableColour);

    soloLowButton.setColour(ToggleButton::textColourId, textColour);
    soloLowButton.setColour(ToggleButton::tickColourId, tickColour);
    soloLowButton.setColour(ToggleButton::tickDisabledColourId, disableColour);
    
}



void IceyGateAudioProcessorEditor::newSliderStyle(Colour textColour, float trackTransp, Slider::TextEntryBoxPosition textBoxStyle, bool readonly, int width, int height)
{
    

    thresholdSlider.setColour(Slider::trackColourId, Colour::fromRGBA(7, 165, 18, 30));
    thresholdSlider.setColour(Slider::textBoxTextColourId, textColour);
    thresholdSlider.setSliderStyle(Slider::LinearBarVertical);
   
    
    
    thresholdLowSlider.setColour(Slider::trackColourId, Colour::fromRGBA(7, 112, 165, 30));
    thresholdLowSlider.setColour(Slider::textBoxTextColourId, textColour);
    thresholdLowSlider.setSliderStyle(Slider::LinearBarVertical);
    

    attackSlider.setColour(Slider::trackColourId, Colour(7, 165, 18));
    attackSlider.setColour(Slider::textBoxTextColourId, textColour);
    attackSlider.setSliderStyle(Slider::LinearBar);
    attackSlider.setAlpha(trackTransp);

    holdSlider.setColour(Slider::trackColourId, Colour(7, 165, 18));
    holdSlider.setColour(Slider::textBoxTextColourId, textColour);
    holdSlider.setSliderStyle(Slider::LinearBar);
    holdSlider.setAlpha(trackTransp);
    ...
    attackLowSlider.setColour(Slider::trackColourId, Colour(7, 112, 165));
    attackLowSlider.setColour(Slider::textBoxTextColourId, textColour);
    attackLowSlider.setSliderStyle(Slider::LinearBar);
    attackLowSlider.setAlpha(trackTransp);

    holdLowSlider.setColour(Slider::trackColourId, Colour(7, 112, 165));
    holdLowSlider.setColour(Slider::textBoxTextColourId, textColour);
    holdLowSlider.setSliderStyle(Slider::LinearBar);
    holdLowSlider.setAlpha(trackTransp);

    releaseLowSlider.setColour(Slider::trackColourId, Colour(7, 112, 165));
    releaseLowSlider.setColour(Slider::textBoxTextColourId, textColour);
    releaseLowSlider.setSliderStyle(Slider::LinearBar);
    releaseLowSlider.setAlpha(trackTransp);

    crossoverSlider.setColour(Slider::trackColourId, Colour(165, 71, 7));
    crossoverSlider.setColour(Slider::textBoxTextColourId, textColour);
    crossoverSlider.setSliderStyle(Slider::LinearBar);
    crossoverSlider.setAlpha(trackTransp);

    mixSlider.setColour(Slider::trackColourId, Colours::darkgrey);
    mixSlider.setColour(Slider::textBoxTextColourId, textColour);
    mixSlider.setSliderStyle(Slider::LinearBar);
    mixSlider.setAlpha(trackTransp);

    inputGainSlider.setColour(Slider::trackColourId, Colours::darkgrey);
    inputGainSlider.setColour(Slider::textBoxTextColourId, textColour);
    inputGainSlider.setSliderStyle(Slider::LinearBar);
    inputGainSlider.setAlpha(trackTransp);

    outputGainSlider.setColour(Slider::trackColourId, Colours::darkgrey);
    outputGainSlider.setColour(Slider::textBoxTextColourId, textColour);
    ...
    scLPFSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    thresholdSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);

    attackSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    releaseSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    holdSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);

    attackLowSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    releaseLowSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    holdLowSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);

    mixSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);

    inputGainSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
    outputGainSlider.setTextBoxStyle(textBoxStyle, readonly, width, height);
...
void IceyGateAudioProcessorEditor::threshTextStyle(Graphics& g, String name, float x, float y, float width, float fontHeight, bool drawBox)
{
    ...
    if (drawBox == true)
    {
        ...
        g.setColour(Colours::whitesmoke);
        g.setOpacity(0.75f);
        g.drawRect(x, y + (sideMargin * 0.78f), width - (sideMargin * 1.9f), floatHeight, 0.5f);
    }

    //draw Text params
    auto Rect = juce::Rectangle<int>(width - (sideMargin * 1.9f), floatHeight);
    Rect.setPosition(x, y + (sideMargin * 0.78f));
    g.setColour(Colours::darkgrey);
    g.setOpacity(0.3f);
    ...
    g.drawText(name, Rect, Justification::centred, true);


}

void IceyGateAudioProcessorEditor::paramTextStyle(Graphics& g, String name, float x, float y, float width, float fontHeight, bool drawBox, Justification justification, Colour textColour)
{
    float floatHeight = releaseSlider.getHeight();
...
<JUCER_COMPONENT documentType="Component" className="GUI" componentName="" parentClasses="public Component"
                 ...
                 initialHeight="600">
  <BACKGROUND backgroundColour="ff002e45">
    <IMAGE pos="-4 0 404 604" resource="fundo_svg" opacity="1.0" mode="0"/>
  </BACKGROUND>
</JUCER_COMPONENT>
...
// JUCER_RESOURCE: cymbalKillerTitle_svg2, 3341, "../../CymbalKillerTitle.svg"
static const unsigned char resource_NewComponent_cymbalKillerTitle_svg2[] = { 60,63,120,109,108,32,118,101,114,115,105,111,110,61,34,49,46,48,34,32,101,110,99,111,100,105,110,103,61,34,85,84,70,45,56,
...
116,112,58,47,47,119,119,119,46,105,110,107,115,99,97,112,101,46,111,114,103,47,110,97,109,101,115,112,97,99,101,115,47,105,110,107,115,99,97,112,101,34,10,32,32,32,105,100,61,34,83,86,71,82,111,111,116,
34,10,32,32,32,118,101,114,115,105,111,110,61,34,49,46,49,34,10,32,32,32,118,105,101,119,66,111,120,61,34,48,32,48,32,56,53,32,53,53,34,10,32,32,32,104,101,105,103,104,116,61,34,53,53,109,109,34,10,32,
32,32,119,105,100,116,104,61,34,56,53,109,109,34,10,32,32,32,115,111,100,105,112,111,100,105,58,100,111,99,110,97,109,101,61,34,67,121,109,98,97,108,75,105,108,108,101,114,84,105,116,108,101,46,115,118,
103,34,10,32,32,32,105,110,107,115,99,97,112,101,58,118,101,114,115,105,111,110,61,34,48,46,57,50,46,53,32,40,50,48,54,48,101,99,49,102,57,102,44,32,50,48,50,48,45,48,52,45,48,56,41,34,62,10,32,32,60,
115,111,100,105,112,111,100,105,58,110,97,109,101,100,118,105,101,119,10,32,32,32,32,32,112,97,103,101,99,111,108,111,114,61,34,35,102,102,102,102,102,102,34,10,32,32,32,32,32,98,111,114,100,101,114,99,
111,108,111,114,61,34,35,54,54,54,54,54,54,34,10,32,32,32,32,32,98,111,114,100,101,114,111,112,97,99,105,116,121,61,34,49,34,10,32,32,32,32,32,111,98,106,101,99,116,116,111,108,101,114,97,110,99,101,61,
34,49,48,34,10,32,32,32,32,32,103,114,105,100,116,111,108,101,114,97,110,99,101,61,34,49,48,34,10,32,32,32,32,32,103,117,105,100,101,116,111,108,101,114,97,110,99,101,61,34,49,48,34,10,32,32,32,32,32,
105,110,107,115,99,97,112,101,58,112,97,103,101,111,112,97,99,105,116,121,61,34,48,34,10,32,32,32,32,32,105,110,107,115,99,97,112,101,58,112,97,103,101,115,104,97,100,111,119,61,34,50,34,10,32,32,32,32,
32,105,110,107,115,99,97,112,101,58,119,105,110,100,111,119,45,119,105,100,116,104,61,34,49,51,54,54,34,10,32,32,32,32,32,105,110,107,115,99,97,112,101,58